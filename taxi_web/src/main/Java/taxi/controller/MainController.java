...
public class MainController {
    ...
    public String createClient(@RequestParam("name") String name, @RequestParam("surname") String surname,
            @RequestParam("phone_number") String phone, @RequestParam("address") String address, Model model,
            HttpSession session) {
        if (!isAuth(session))
            return "index";
    ...
    public String showClientslist(Model model, HttpSession session) {
        if (!isAuth(session))
            return "index";
        List<Client> list = service.findAllClients();
        log.info("/clients taxi.controller");
        model.addAttribute("clientList", list);
        return "clients";
    }
    ...
    public String showDrivers(Model model, HttpSession session) {
        ...
        log.info("/drivers taxi.controller");
    ...
    public String startRegisterDriver(HttpSession session) {
        if (!isAuth(session))
            return "index";
        log.info("/create taxi.controller");
    ...
    (@RequestParam("name") String name, @RequestParam("model") String carModel,
        ...
        log.info("/newDriver taxi.controller");
    ...
    public String showOperators(Model model, HttpSession session) {
        ...
        log.info("/operators taxi.controller");
    ...
    public String toredactOper(Model model, HttpSession session) {
        ...
        log.info("/changeOperator taxi.controller");
    ...
    public String redactorOper
        ...
        if (operator == null) {
            log.info("/redactOperator taxi.controller");
    ...
    public String newOrder(@RequestParam String client,
    ...
    public String listOrdersByPortion(Model model, HttpSession session) {
        if (!isAuth(session))
            return "index";
        model.addAttribute("orders", service.listAllOrders());
        return "orders";
    ...
    public String listOrdersByMoney(@RequestParam String from,
    ...
    public String auth(@RequestParam String login, @RequestParam String password, Model model, HttpSession session) {
        if (isAuth(session))
            return "dashboard";
        try {
    ...
    public String registerPost(@RequestParam String login,
        ...
        log.info("registerPost taxi.controller");
    ...
    public String changePassword(@RequestParam String login,
            @RequestParam String password,
            @RequestParam String passwordConfirmation,
            Model model,
            HttpSession session) {
    ...
    public String register(HttpSession session) {
        if (isAuth(session))
            return "dashboard";
        log.info("/register.html taxi.controller");
        return "register";
    }
    ...
    private void addOperators() {
        ...
        oper2.setRole(user);
        //        taxi.service.createRole(user);
        //        taxi.service.createRole(admin);
    ...
    public
    @ResponseBody
    String auth2(@RequestParam String login, @RequestParam String password,
            Model model) {
        try {
            authenticationService.authenticate(login, password);
            model.addAttribute("loginId", login);
    ...
    public
    @ResponseBody
    String register2(@RequestParam String login, @RequestParam String password,
            @RequestParam String itn,
            Model model) {
        System.out.println("in Register 2");
        try {
            authorizationService.register(login, itn, password);
            System.out.println("no taxi.exception");
            return "1";
        } catch (Exception exception) {
            System.out.println("taxi/exception");
            System.out.println(exception.getMessage());
    ...
    String ajaxDrivers(Model model) {
        ...
        if (taxiDrivers == null) {
            ...
            String result =
                    "Table of taxi-drivers, Driver's name | Car model | Car number | Driver phone," + drivResult;
    ...
    String ajaxOrders(Model model) {
        ...
        if (orders == null) {
            ...
            String result =
                    "Table of orders, Operator | Driver's name | Order Date | Amount in cents | Start point | Point of destination,"
                            + orderResult;
            result = result.replace(']', ' ').replace('[', ' ').trim();
    ...
    String ajaxOrdersPortioned(@RequestParam("numberOfPortion") String numberOfPortion, Model model) {
        ...
        if (orders == null) {
            ...
            String orderResult = orders.toString();
            String result = "portion of orders № " + numberOfPortion
                    + " , Operator | Driver's name | Order Date | Amount in cents | Start point | Point of destination,"
                    + orderResult;
            result = result.replace(']', ' ').replace('[', ' ').trim();
            return result;
        }
    ...
    public
    @ResponseBody
    String ajaxAmount(@RequestParam("amountFrom") String amountFrom, @RequestParam("amountTo") String amountTo,
            Model model) {
        ...
        if (orders == null) {
            ...
            String orderResult = orders.toString();
            String result = "orders with amount between " + amountFrom + " and " + amountTo
                    + ", Operator | Driver's name | Order Date | Amount in cents | Start point | Point of destination,"
                    + orderResult;
            result = result.replace(']', ' ').replace('[', ' ').trim();
            return result;
    ...
    String ajaxClients(Model model) {
        ...
        if (clients == null) {
            ...
            String result = "Clients,Name | Surname | Phone number | Address | Total money spent | Date of last change,"
                    + clientResult;
            result = result.replace(']', ' ').replace('[', ' ').trim();
            return result;
        }
    ...
    String ajaxClientsPortioned(@RequestParam("numberOfPortion") String numberOfPortion, Model model) {
        ...
        if (clients == null) {
            ...
            String clientResult = clients.toString();
            String result = "Portion № " + numberOfPortion
                    + "of clients , Name | Surname | Phone number | Address | Total money spent | Date of last change,"
                    + clientResult;
            result = result.replace(']', ' ').replace('[', ' ').trim();
            return result;
        }
    ...
    String ajaxClientsMonth(Model model) {
        ...
        if (clients == null) {
            ...
            String clientResult = clients.toString();
            String result =
                    "Clients made orders last month, Name | Surname | Phone number | Address | Total money spent | Date of last change,"
                            + clientResult;
            result = result.replace(']', ' ').replace('[', ' ').trim();
            return result;
        }
    ...
    String ajaxClientsAmount(@RequestParam("amount") String amount, Model model) {
        ...
        if (clients == null) {
            ...
            String clientResult = clients.toString();
            String result = "CLients made orders in amount more then " + amount
                    + ", Name | Surname | Phone number | Address | Total money spent | Date of last change,"
                    + clientResult;
            result = result.replace(']', ' ').replace('[', ' ').trim();
            return result;
        }

...
public class AuthorizationServiceImpl implements AuthorizationService {
    ...
    @Transactional
    @Override
    public boolean register(String login, String individualTaxpayerNumber, String password)
            throws AuthorizationException {
        System.out.println("in register taxi.service");
        ...
        Operator operator = new Operator(login, password, Long.parseLong(individualTaxpayerNumber), "", now, false, 0L,
                USER);
